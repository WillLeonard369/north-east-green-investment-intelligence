...
def load_historical_labour_market() -> None:
    ...
    with sqlite3.connect(DATABASE_PATH) as connection:
        ...
        cursor.execute(
            ...
            (
                ...
                "National and regional headline indicators",
            ),
        )
    ...
    print(
        f"Loaded {len(dataframe)} historical labour-market observations "
